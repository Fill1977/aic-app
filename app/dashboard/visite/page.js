...
import VisiteView from "./VisiteView";
...
export default async function VisitePage({ searchParams }) {
  ...
  const [{ data: visite }, { data: lavoratori }] = await Promise.all([
    supabase.rpc("visite_slug", { p_slug: slug }),
  ...
  return (
    <div className="shell">
      ...
      <div className="main">
        <header className="topbar"><h1>Sorveglianza sanitaria</h1></header>
        <div className="content">
          <VisiteView visite={visite||[]} lavoratori={lavoratori||[]}
